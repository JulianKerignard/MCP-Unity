            ...
            _toolRegistry.RegisterTool(new McpToolDefinition
            {
                ...
                inputSchema = new McpInputSchema
                {
                    ...
                    properties = new Dictionary<string, McpPropertySchema>
                    {
                        ...
                        ["volume"] = new McpPropertySchema { type = "number", description = "Volume 0-1 (default: 1)" },
                        ["pitch"] = new McpPropertySchema { type = "number", description = "Pitch (default: 1)" },
                        ["loop"] = new McpPropertySchema { type = "boolean", description = "Loop playback (default: false)" },
                        ["playOnAwake"] = new McpPropertySchema { type = "boolean", description = "Play on awake (default: true)" },
                        ["spatialBlend"] = new McpPropertySchema { type = "number", description = "Spatial blend 0=2D, 1=3D (default: 0)" },
                        ["minDistance"] = new McpPropertySchema { type = "number", description = "3D min distance (default: 1)" },
                        ["maxDistance"] = new McpPropertySchema { type = "number", description = "3D max distance (default: 500)" },
