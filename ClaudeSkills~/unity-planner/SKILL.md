...
- MCP Unity skill installed at `~/.claude/skills/mcp-unity/`
...
| **Unity Developer** | Implementation via all 164 MCP tools | ALL tools — cross-ref `~/.claude/skills/mcp-unity/SKILL.md` |
...
3. **Cross-skill reference**: Points to `~/.claude/skills/mcp-unity/SKILL.md` for tool details. Never duplicates the 164-tool reference.
