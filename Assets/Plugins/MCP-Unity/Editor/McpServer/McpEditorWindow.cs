...
namespace McpUnity.Editor
{
    ...
    /// Accessible via Conductor Window > MCP Unity
    /// </summary>
    public partial class McpEditorWindow : EditorWindow
    {
        ...
        [MenuItem("Conductor Window/MCP Unity", priority = 100)]
        public static void ShowWindow()
        {
            var window = GetWindow<McpEditorWindow>("Conductor Window");
            window.minSize = new Vector2(420, 500);
            window.Show();
        }

        [MenuItem("Conductor Window/Quick Start Server", priority = 101)]
        ...
        private void DrawHeader()
        {
            ...
            EditorGUILayout.LabelField("Conductor Window", _headerStyle);
