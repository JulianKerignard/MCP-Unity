...
namespace McpUnity.Protocol
{
    ...
    public class JsonRpcRequest
    {
        ...
        public T GetParams<T>() where T : class
        {
            ...
            // Use JsonHelper (supports Dictionary<string,object>) instead of JsonUtility
            var json = McpUnity.Server.JsonHelper.ToJson(@params);
    ...
    public class JsonRpcError
    {
        ...
        public const int ConnectionError = -32000;
